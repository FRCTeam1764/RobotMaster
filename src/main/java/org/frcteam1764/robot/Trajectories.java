...
public class Trajectories {
	...
	.lineTo(new Vector2(-15.0, -85.0), Rotation2.fromDegrees(-105.0))
	 .lineTo(new Vector2(-15.0, -140.0), Rotation2.fromDegrees(-120.0))
	 .lineTo(new Vector2(-20.0, -135.0), Rotation2.fromDegrees(-10.0))
	 .lineTo(new Vector2(-25.0, -85.0), Rotation2.fromDegrees(-10.0))
	.build();
	...
	.lineTo(new Vector2(55.0, 0.0), Rotation2.fromDegrees(0.0))
	...
	public static Trajectory[] getTrajectories() {
		Trajectory[] trajectories =  new Trajectory[]{
			...
			Utilities.convertPathToTrajectory(twoBallAuto, 70.0, 90.0),
