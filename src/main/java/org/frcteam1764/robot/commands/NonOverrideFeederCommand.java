...
public class NonOverrideFeederCommand extends ParallelCommandGroup {
  /** Creates a new IntakeBallCommand. */

  public NonOverrideFeederCommand(
    ...
    addCommands(
      new ConveyorCommand(conveyor, conveyorSpeed, false),
      new ElevatorCommand(elevator, elevatorSpeed, false)
    );
  }
}