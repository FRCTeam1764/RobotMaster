...
public class RobotConstants {
    ...
    public static final int DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR = 9;
    ...
    public static final int DRIVETRAIN_FRONT_LEFT_ENCODER_PORT = 18;
    public static final int DRIVETRAIN_FRONT_RIGHT_ENCODER_PORT = 16;
    public static final int DRIVETRAIN_BACK_LEFT_ENCODER_PORT = 15;
    public static final int DRIVETRAIN_BACK_RIGHT_ENCODER_PORT = 21;

    // In degrees
    // increasing turns clockwise
    public static final double DRIVETRAIN_FRONT_LEFT_ENCODER_OFFSET = Math.toRadians(92.06268310546875+180);
    public static final double DRIVETRAIN_FRONT_RIGHT_ENCODER_OFFSET = Math.toRadians(300.662841796875+180);
    public static final double DRIVETRAIN_BACK_LEFT_ENCODER_OFFSET = Math.toRadians(108.25927734375+180);
    public static final double DRIVETRAIN_BACK_RIGHT_ENCODER_OFFSET = Math.toRadians(191.6976928710937+180);
}
