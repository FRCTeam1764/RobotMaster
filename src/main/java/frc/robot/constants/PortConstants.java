...
public class PortConstants {
    ...
    public static final int RIGHT_FRONT_MOTOR_PORT = 31;
    public static final int RIGHT_MIDDLE_MOTOR_PORT = 32;
    public static final int RIGHT_BACK_MOTOR_PORT = 33;

    public static final int LEFT_FRONT_MOTOR_PORT = 34;
    public static final int LEFT_MIDDLE_MOTOR_PORT = 35;
    public static final int LEFT_BACK_MOTOR_PORT = 36;
